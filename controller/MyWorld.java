...
public class MyWorld extends World
{
    ...
    {
        super(800, 600, 1);
        setPaintOrder(Information.class,StartScreen.class, Score.class,Speed.class,ScoreBoard.class, Dot.class, Path.class, Skater.class, Blocker.class, EndLine.class, Lives.class, Background.class);
